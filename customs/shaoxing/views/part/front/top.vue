<template>
  <div class="front-top" :style="{'pointer-events':theme=='check'?'auto':'none'}">
    <div v-if="theme=='check'">
      <panle title="视频监控">
        <el-row :gutter="10" type="flex" justify="space-evenly" style="margin-top: 10px;">
          <el-col
            :span="4"
            v-for="chid in camerasData.chid"
            :key="chid"
            style="position: relative;    top: -4px;"
          >
            <img :src="chid" width="100%" height="103px;" frameborder="0">
    ...
    <div v-if="theme=='applypump'">
      <div class="icon-wrapper" style="padding-top:30px;background: rgba(0, 0, 0, 0.0)">
        <div class="sg-icon">
          ...
          <div class="sg-text">当日热线</div>
          <div class="sg-num">{{gd.tadayHotLine}}</div>
          <div class="clear">
            <div
        ...
        <div class="sg-icon">
          ...
          ></div>
          <div class="sg-pot"></div>
          <div class="sg-text">当月热线</div>
          <div class="sg-num">{{gd.monthHotLine}}</div>
          <div class="clear">
            <div
              style="float:left;margin-left:-2px;border-top:solid 2px #01cef6;border-radius:5px;width:16px"
            ></div>
        ...
        <div class="sg-icon">
          ...
          ></div>
          <div class="sg-pot"></div>
          <div class="sg-text">当年热线</div>
          <div class="sg-num">{{gd.yearHotLine}}</div>
          <div class="clear">
            <div
              style="float:left;margin-left:-2px;border-top:solid 2px #01cef6;border-radius:5px;width:16px"
            ></div>
        ...
        <div class="sg-icon">
          ...
          ></div>
          <div class="sg-pot"></div>
          <div class="sg-text">当日工单</div>
          <div class="sg-num">{{gd.todayWorkOrder}}</div>
          <div class="clear">
            <div
              style="float:left;margin-left:-2px;border-top:solid 2px #01cef6;border-radius:5px;width:16px"
            ></div>
        ...
        <div class="sg-icon">
          ...
          ></div>
          <div class="sg-pot"></div>
          <div class="sg-text">当月工单</div>
          <div class="sg-num">{{gd.monthWorkOrder}}</div>
          <div class="clear">
            <div
              style="float:left;margin-left:-2px;border-top:solid 2px #01cef6;border-radius:5px;width:16px"
            ></div>
        ...
        <div class="sg-icon">
          ...
          ></div>
          <div class="sg-pot"></div>
          <div class="sg-text">当年工单</div>
          <div class="sg-num">{{gd.yearWorkOrder}}</div>
          <div class="clear">
            <div
              style="float:left;margin-left:-2px;border-top:solid 2px #01cef6;border-radius:5px;width:16px"
            ></div>
    ...
    <el-dialog
      title="视频"
      :visible.sync="camerasData.dialogVideoVisible"
      :modal-append-to-body="false"
    >
      <iframe
        :src="'http://61.175.245.204:1111/static/dvr/video.html?autoplay=1&dlg=1&ip=ip&port=port&account=acc&password=pwd&type=rtsp_h264&channel='+camerasData.currentChid"
        width="100%"
        height="500px;"
        frameborder="0"
      ></iframe>
...
/* import img1 from 'https://lg-m1opkjhk-1256679880.cos.ap-shanghai.myqcloud.com/03.png'
import img2 from 'https://lg-m1opkjhk-1256679880.cos.ap-shanghai.myqcloud.com/05.png'
import img3 from 'https://lg-m1opkjhk-1256679880.cos.ap-shanghai.myqcloud.com/07.png'
import img4 from 'https://lg-m1opkjhk-1256679880.cos.ap-shanghai.myqcloud.com/09.png'
import img5 from 'https://lg-m1opkjhk-1256679880.cos.ap-shanghai.myqcloud.com/11.png' */
export default {
    props: {
        theme: ''
    },
        ...
        return {
            ...
            camerasData: {
                ...
                'rtsp://140.80.3.2:554/pag://140.80.3.2:7302:11121321001310000001:0:MAIN:TCP?cnid=1&pnid=1&auth=50', */
                   ...
                   /*  '/static/images/camer/03.png',
                    '/static/images/camer/05.png',
                    '/static/images/camer/07.png',
                    '/static/images/camer/09.png',
                    '/static/images/camer/11.png' */
